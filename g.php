...
<footer id="pieds">
	<h3>Ce site a été conçu par Monsieur BANGUISSA BAZOLASSANA Juste Gabin By EXPERTISE-TIC-2023</h3>
</footer>
...
<head>
	...
	<title>Juste Gabin</title>
<div id="bloc1">
	<div id="bloc2">
		<h1 id="ecrit1">BBC</h1>
		<h1 id="ecrit2">TRAVEL</h1>
	...
	<div id="bloc3">
		...
		<li><a href="#">GALLERY</a>
		<li><a href="#">FAIRE UNE RESERVATION</a>
...
<body id="corps">
  ...
  <div> 
  		<form method="POST">
  			...
  			<label> Nom:</label><input type="text" name="Nom" placeholder="Saisissez votre Nom" required> <br> <br> 
  			<label> Email:</label><input type="Email" name="Email" placeholder="Saisissez votre email" required> <br> <br> 
